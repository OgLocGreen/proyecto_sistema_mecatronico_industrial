...
-- Equation(s):
-- \inst|LessThan0~6_combout\ = (!\inst|cnt\(6) & (!\inst|cnt\(7) & ((!\inst|cnt\(5)) # (!\inst|cnt\(4)))))
...
-- Equation(s):
-- \inst|LessThan0~0_combout\ = (!\inst|cnt\(18) & (!\inst|cnt\(17) & (!\inst|cnt\(15) & !\inst|cnt\(16))))
...
-- Equation(s):
-- \inst|LessThan0~1_combout\ = (!\inst|cnt\(22) & (!\inst|cnt\(19) & (!\inst|cnt\(21) & !\inst|cnt\(20))))
...
-- Equation(s):
-- \inst|LessThan0~3_combout\ = (!\inst|cnt\(28) & (!\inst|cnt\(27) & (!\inst|cnt\(30) & !\inst|cnt\(29))))
...
-- Equation(s):
-- \inst|LessThan0~2_combout\ = (!\inst|cnt\(23) & (!\inst|cnt\(24) & (!\inst|cnt\(25) & !\inst|cnt\(26))))
...
-- Equation(s):
-- \inst|LessThan0~4_combout\ = (\inst|LessThan0~0_combout\ & (\inst|LessThan0~1_combout\ & (\inst|LessThan0~3_combout\ & \inst|LessThan0~2_combout\)))
...
-- Equation(s):
-- \inst4|Equal0~2_combout\ = (!\inst4|r_Clk_Count\(6) & (\inst4|r_Clk_Count\(9) & (\inst4|r_Clk_Count\(11) & !\inst4|r_Clk_Count\(10))))
...
-- Equation(s):
-- \inst4|Equal0~0_combout\ = (\inst4|r_Clk_Count\(1) & (\inst4|r_Clk_Count\(0) & (!\inst4|r_Clk_Count\(7) & !\inst4|r_Clk_Count\(8))))
...
-- Equation(s):
-- \inst4|LessThan1~5_combout\ = (\inst4|LessThan1~1_combout\ & ((\inst4|LessThan1~2_combout\) # ((!\inst4|r_Clk_Count\(10) & !\inst4|r_Clk_Count\(11))))) # (!\inst4|LessThan1~1_combout\ & (!\inst4|r_Clk_Count\(10) & (!\inst4|r_Clk_Count\(11))))
...
-- Equation(s):
-- \inst4|Selector14~0_combout\ = (\inst4|r_SM_Main.s_RX_Data_Bits~q\ & (((!\inst4|r_Bit_Index\(0)) # (!\inst4|LessThan1~4_combout\)))) # (!\inst4|r_SM_Main.s_RX_Data_Bits~q\ & (\inst4|r_SM_Main.s_Idle~q\))
...
-- Equation(s):
-- \inst4|Selector14~2_combout\ = (\inst4|Selector14~0_combout\ & ((\inst4|r_Bit_Index\(2)) # ((\inst4|Decoder0~0_combout\ & \inst4|Selector14~1_combout\)))) # (!\inst4|Selector14~0_combout\ & (\inst4|Decoder0~0_combout\ & ((\inst4|Selector14~1_combout\))))
...
PORT MAP (
	...
	datad => \inst4|Selector14~1_combout\,
...
-- Equation(s):
-- \inst4|r_SM_Main.s_RX_Stop_Bit~0_combout\ = (\inst4|r_Bit_Index\(0) & (\inst4|r_Bit_Index\(2) & \inst4|r_Bit_Index\(1)))
...
PORT MAP (
	...
	datad => \inst4|r_SM_Main.s_RX_Stop_Bit~0_combout\,
...
-- Equation(s):
-- \inst4|r_SM_Main~7_combout\ = (\inst4|LessThan1~4_combout\ & \inst4|r_SM_Main.s_RX_Stop_Bit~q\)
...
-- Equation(s):
-- \inst4|Equal0~3_combout\ = (\inst4|Equal0~2_combout\ & (\inst4|Equal0~0_combout\ & (\inst4|Equal0~1_combout\ & !\inst4|r_Clk_Count\(12))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst4|r_SM_Main.s_RX_Stop_Bit~q\,
	datac => \inst4|r_SM_Main.s_RX_Data_Bits~q\,
...
PORT MAP (
	...
	datab => \inst4|r_Clk_Count[7]~39_combout\,
	datac => \inst4|LessThan1~4_combout\,
	datad => \inst4|r_SM_Main.s_Idle~q\,
...
-- Equation(s):
-- \inst4|LessThan1~4_combout\ = (\inst4|r_Clk_Count\(12) & (!\inst4|LessThan1~3_combout\ & ((!\inst4|LessThan1~1_combout\) # (!\inst4|LessThan1~2_combout\))))
...
PORT MAP (
	dataa => \inst4|LessThan1~4_combout\,
	datab => \inst4|Selector19~1_combout\,
	datac => \inst4|r_SM_Main.s_RX_Data_Bits~q\,
	datad => \inst4|r_SM_Main.s_RX_Stop_Bit~0_combout\,
...
-- Equation(s):
-- \inst4|Decoder0~1_combout\ = (\inst4|r_Bit_Index\(1) & (!\inst4|r_Bit_Index\(0) & (\inst4|r_Bit_Index\(2) & \inst4|Decoder0~0_combout\)))
...
-- Equation(s):
-- \inst4|Decoder0~2_combout\ = (\inst4|r_Bit_Index\(1) & (\inst4|r_Bit_Index\(0) & (\inst4|r_Bit_Index\(2) & \inst4|Decoder0~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst4|Decoder0~2_combout\,
	datab => \pin_serial~input_o\,
...
-- Equation(s):
-- \inst2|Equal0~0_combout\ = (!\inst2|count\(12) & (\inst2|count\(14) & (!\inst2|count\(13) & \inst2|count\(11))))
...
-- Equation(s):
-- \inst2|Equal0~1_combout\ = (!\inst2|count\(7) & (!\inst2|count\(8) & (\inst2|count\(10) & \inst2|count\(9))))
...
-- Equation(s):
-- \inst2|Equal0~2_combout\ = (!\inst2|count\(3) & (!\inst2|count\(6) & (!\inst2|count\(4) & \inst2|count\(5))))
...
-- Equation(s):
-- \inst4|Decoder0~5_combout\ = (\inst4|r_Bit_Index\(1) & (\inst4|r_Bit_Index\(0) & (!\inst4|r_Bit_Index\(2) & \inst4|Decoder0~0_combout\)))
...
-- Equation(s):
-- \inst4|Decoder0~6_combout\ = (\inst4|r_Bit_Index\(1) & (!\inst4|r_Bit_Index\(0) & (!\inst4|r_Bit_Index\(2) & \inst4|Decoder0~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst4|Decoder0~6_combout\,
	datab => \pin_serial~input_o\,
...
-- Equation(s):
-- \inst4|Decoder0~4_combout\ = (!\inst4|r_Bit_Index\(1) & (!\inst4|r_Bit_Index\(0) & (\inst4|r_Bit_Index\(2) & \inst4|Decoder0~0_combout\)))
...
-- Equation(s):
-- \inst2|Mult0|mult_core|_~0_combout\ = (\inst4|r_RX_Byte\(3) & (!\inst4|r_RX_Byte\(2) & \inst4|r_RX_Byte\(4)))
...
-- Equation(s):
-- \inst2|Mult0|mult_core|_~1_combout\ = (\inst4|r_RX_Byte\(3) & (\inst4|r_RX_Byte\(2) & \inst4|r_RX_Byte\(4)))
...
-- Equation(s):
-- \inst2|Mult0|mult_core|romout[1][5]~0_combout\ = (\inst4|r_RX_Byte\(3) & (\inst4|r_RX_Byte\(2) & !\inst4|r_RX_Byte\(4))) # (!\inst4|r_RX_Byte\(3) & ((\inst4|r_RX_Byte\(4))))
...
-- Equation(s):
-- \inst2|Mult0|mult_core|_~3_combout\ = (!\inst4|r_RX_Byte\(3) & (\inst4|r_RX_Byte\(2) & \inst4|r_RX_Byte\(4)))
...
-- Equation(s):
-- \inst2|Mult0|mult_core|_~2_combout\ = (\inst4|r_RX_Byte\(3) & (!\inst4|r_RX_Byte\(2) & !\inst4|r_RX_Byte\(4)))
...
-- Equation(s):
-- \inst4|Decoder0~7_combout\ = (!\inst4|r_Bit_Index\(1) & (\inst4|r_Bit_Index\(0) & (!\inst4|r_Bit_Index\(2) & \inst4|Decoder0~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst4|Decoder0~7_combout\,
	datab => \pin_serial~input_o\,
...
-- Equation(s):
-- \inst4|Decoder0~8_combout\ = (!\inst4|r_Bit_Index\(1) & (!\inst4|r_Bit_Index\(0) & (!\inst4|r_Bit_Index\(2) & \inst4|Decoder0~0_combout\)))
...
-- Equation(s):
-- \inst2|Mult0|mult_core|romout[1][3]~1_combout\ = (\inst4|r_RX_Byte\(3) & (\inst4|r_RX_Byte\(2) & \inst4|r_RX_Byte\(4))) # (!\inst4|r_RX_Byte\(3) & (\inst4|r_RX_Byte\(2) $ (\inst4|r_RX_Byte\(4))))
...
-- Equation(s):
-- \inst2|Mult0|mult_core|romout[1][2]~2_combout\ = \inst4|r_RX_Byte\(4) $ (((\inst4|r_RX_Byte\(3) & !\inst4|r_RX_Byte\(2))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst2|Mult0|mult_core|romout[0][3]~4_combout\,
	datad => VCC,
...
-- pragma translate_on
PORT MAP (
	dataa => \inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~10_combout\,
	datad => VCC,
	cin => \inst2|Add0~13\,
...
-- Equation(s):
-- \inst2|LessThan1~20_cout\ = CARRY((\inst2|count\(10) & (\inst2|Add0~16_combout\ & !\inst2|LessThan1~18_cout\)) # (!\inst2|count\(10) & ((\inst2|Add0~16_combout\) # (!\inst2|LessThan1~18_cout\))))
...
-- Equation(s):
-- \inst2|LessThan1~23_combout\ = (!\inst2|count\(13) & (!\inst2|LessThan1~21_combout\ & (!\inst2|count\(12) & !\inst2|count\(14))))
...
-- Equation(s):
-- \inst4|Decoder0~3_combout\ = (!\inst4|r_Bit_Index\(1) & (\inst4|r_Bit_Index\(0) & (\inst4|r_Bit_Index\(2) & \inst4|Decoder0~0_combout\)))
