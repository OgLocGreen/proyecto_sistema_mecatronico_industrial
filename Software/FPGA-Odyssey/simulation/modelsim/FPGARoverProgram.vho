...
-- reseteo	=>  Location: PIN_A10,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \inst4|r_Clk_Count[9]~41_combout\ : std_logic;
...
SIGNAL \inst4|r_Clk_Count[9]~39_combout\ : std_logic;
SIGNAL \inst4|r_Clk_Count[9]~40_combout\ : std_logic;
...
SIGNAL \reseteo~input_o\ : std_logic;
SIGNAL \inst|dir~0_combout\ : std_logic;
SIGNAL \inst|en~0_combout\ : std_logic;
...
SIGNAL \inst4|ALT_INV_r_RX_Byte\ : std_logic_vector(7 DOWNTO 0);
...
\inst4|ALT_INV_r_RX_Byte\(0) <= NOT \inst4|r_RX_Byte\(0);
\inst4|ALT_INV_r_RX_Byte\(1) <= NOT \inst4|r_RX_Byte\(1);
\inst4|ALT_INV_r_RX_Byte\(2) <= NOT \inst4|r_RX_Byte\(2);
\inst4|ALT_INV_r_RX_Byte\(5) <= NOT \inst4|r_RX_Byte\(5);
\inst4|ALT_INV_r_RX_Byte\(7) <= NOT \inst4|r_RX_Byte\(7);
\inst4|ALT_INV_r_RX_Byte\(6) <= NOT \inst4|r_RX_Byte\(6);
...
-- Equation(s):
-- \inst|LessThan0~5_combout\ = ((!\inst|cnt\(13)) # (!\inst|cnt\(14))) # (!\inst|cnt\(12))
...
-- Equation(s):
-- \inst|LessThan0~1_combout\ = (!\inst|cnt\(19) & (!\inst|cnt\(21) & (!\inst|cnt\(20) & !\inst|cnt\(22))))
...
-- Equation(s):
-- \inst|LessThan0~0_combout\ = (!\inst|cnt\(16) & (!\inst|cnt\(18) & (!\inst|cnt\(15) & !\inst|cnt\(17))))
...
-- Equation(s):
-- \inst|LessThan0~4_combout\ = (\inst|LessThan0~3_combout\ & (\inst|LessThan0~1_combout\ & (\inst|LessThan0~2_combout\ & \inst|LessThan0~0_combout\)))
...
-- Equation(s):
-- \inst|LessThan0~6_combout\ = (!\inst|cnt\(7) & (!\inst|cnt\(6) & ((!\inst|cnt\(4)) # (!\inst|cnt\(5)))))
...
-- Equation(s):
-- \inst|LessThan0~7_combout\ = ((!\inst|cnt\(9) & ((\inst|LessThan0~6_combout\) # (!\inst|cnt\(8))))) # (!\inst|cnt\(10))
...
-- Equation(s):
-- \inst|LessThan0~8_combout\ = ((!\inst|LessThan0~5_combout\ & ((\inst|cnt\(11)) # (!\inst|LessThan0~7_combout\)))) # (!\inst|LessThan0~4_combout\)
...
PORT MAP (
	...
	sclr => \inst4|r_Clk_Count[9]~40_combout\,
	ena => \inst4|r_Clk_Count[9]~41_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \inst4|LessThan1~5_combout\ = (\inst4|LessThan1~2_combout\ & ((\inst4|LessThan1~1_combout\) # ((!\inst4|r_Clk_Count\(11) & !\inst4|r_Clk_Count\(10))))) # (!\inst4|LessThan1~2_combout\ & (!\inst4|r_Clk_Count\(11) & ((!\inst4|r_Clk_Count\(10)))))
...
-- Equation(s):
-- \inst4|Selector17~0_combout\ = (!\inst4|r_SM_Main.s_Cleanup~q\ & (((\inst4|r_SM_Main.s_Idle~q\ & !\inst4|Selector19~0_combout\)) # (!\pin_serial~input_o\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst4|r_SM_Main.s_Cleanup~q\,
...
-- Equation(s):
-- \inst4|Selector18~0_combout\ = (\inst4|Equal0~3_combout\ & (!\pin_serial~input_o\ & ((!\inst4|r_SM_Main.s_Idle~q\)))) # (!\inst4|Equal0~3_combout\ & ((\inst4|r_SM_Main.s_RX_Start_Bit~q\) # ((!\pin_serial~input_o\ & !\inst4|r_SM_Main.s_Idle~q\))))
...
-- Equation(s):
-- \inst4|Selector19~1_combout\ = (\inst4|Equal0~3_combout\ & (!\pin_serial~input_o\ & \inst4|r_SM_Main.s_RX_Start_Bit~q\))
...
PORT MAP (
	...
	datad => \inst4|r_SM_Main.s_RX_Start_Bit~q\,
	combout => \inst4|Selector19~1_combout\);

-- Location: LCCOMB_X25_Y4_N20
\inst4|Selector19~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|Selector19~2_combout\ = (\inst4|Selector19~1_combout\) # ((\inst4|r_SM_Main.s_RX_Data_Bits~q\ & ((!\inst4|r_SM_Main.s_RX_Stop_Bit~0_combout\) # (!\inst4|LessThan1~4_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst4|LessThan1~4_combout\,
...
-- Equation(s):
-- \inst4|Selector16~1_combout\ = (\inst4|Selector16~0_combout\ & (\inst4|r_Bit_Index\(0) $ (((!\inst4|LessThan1~5_combout\ & \inst4|r_SM_Main.s_RX_Data_Bits~q\))))) # (!\inst4|Selector16~0_combout\ & (((\inst4|r_Bit_Index\(0) & 
-- \inst4|r_SM_Main.s_RX_Data_Bits~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst4|LessThan1~5_combout\,
...
-- Equation(s):
-- \inst4|r_SM_Main.s_RX_Stop_Bit~1_combout\ = (\inst4|LessThan1~4_combout\ & (\inst4|r_SM_Main.s_RX_Stop_Bit~0_combout\ & ((\inst4|r_SM_Main.s_RX_Data_Bits~q\)))) # (!\inst4|LessThan1~4_combout\ & (((\inst4|r_SM_Main.s_RX_Stop_Bit~q\))))
...
\inst4|r_Clk_Count[9]~41\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|r_Clk_Count[9]~41_combout\ = (!\inst4|r_SM_Main.s_Cleanup~q\ & (((!\inst4|r_SM_Main.s_RX_Start_Bit~q\) # (!\pin_serial~input_o\)) # (!\inst4|Equal0~3_combout\)))
...
PORT MAP (
	...
	datac => \pin_serial~input_o\,
	datad => \inst4|r_SM_Main.s_RX_Start_Bit~q\,
	combout => \inst4|r_Clk_Count[9]~41_combout\);
...
-- Equation(s):
-- \inst4|Equal0~0_combout\ = (\inst4|r_Clk_Count\(0) & (!\inst4|r_Clk_Count\(8) & (!\inst4|r_Clk_Count\(7) & \inst4|r_Clk_Count\(1))))
...
PORT MAP (
	...
	datad => \inst4|r_Clk_Count\(1),
	combout => \inst4|Equal0~0_combout\);

-- Location: LCCOMB_X23_Y4_N28
\inst4|Equal0~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|Equal0~2_combout\ = (\inst4|r_Clk_Count\(9) & (\inst4|r_Clk_Count\(11) & (!\inst4|r_Clk_Count\(6) & !\inst4|r_Clk_Count\(10))))
...
\inst4|r_Clk_Count[9]~39\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|r_Clk_Count[9]~39_combout\ = (\inst4|r_SM_Main.s_RX_Stop_Bit~q\) # (\inst4|r_SM_Main.s_RX_Data_Bits~q\)
...
PORT MAP (
	datac => \inst4|r_SM_Main.s_RX_Stop_Bit~q\,
	datad => \inst4|r_SM_Main.s_RX_Data_Bits~q\,
	combout => \inst4|r_Clk_Count[9]~39_combout\);

-- Location: LCCOMB_X25_Y4_N26
\inst4|r_Clk_Count[9]~40\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|r_Clk_Count[9]~40_combout\ = (\inst4|Selector19~0_combout\) # (((\inst4|LessThan1~4_combout\ & \inst4|r_Clk_Count[9]~39_combout\)) # (!\inst4|r_SM_Main.s_Idle~q\))
...
PORT MAP (
	...
	datac => \inst4|r_Clk_Count[9]~39_combout\,
	datad => \inst4|r_SM_Main.s_Idle~q\,
	combout => \inst4|r_Clk_Count[9]~40_combout\);
...
-- Equation(s):
-- \inst4|LessThan1~2_combout\ = (!\inst4|r_Clk_Count\(7) & (!\inst4|r_Clk_Count\(11) & (!\inst4|r_Clk_Count\(9) & !\inst4|r_Clk_Count\(8))))
...
-- Equation(s):
-- \inst4|LessThan1~4_combout\ = (!\inst4|LessThan1~3_combout\ & (\inst4|r_Clk_Count\(12) & ((!\inst4|LessThan1~1_combout\) # (!\inst4|LessThan1~2_combout\))))
...
-- Equation(s):
-- \inst4|Decoder0~0_combout\ = (\inst4|LessThan1~4_combout\ & \inst4|r_SM_Main.s_RX_Data_Bits~q\)
...
-- Equation(s):
-- \inst4|Selector14~2_combout\ = (\inst4|Decoder0~0_combout\ & ((\inst4|Selector14~1_combout\) # ((\inst4|r_Bit_Index\(2) & \inst4|Selector14~0_combout\)))) # (!\inst4|Decoder0~0_combout\ & (((\inst4|r_Bit_Index\(2) & \inst4|Selector14~0_combout\))))
...
-- Equation(s):
-- \inst4|Decoder0~1_combout\ = (\inst4|r_Bit_Index\(2) & (\inst4|Decoder0~0_combout\ & (!\inst4|r_Bit_Index\(0) & \inst4|r_Bit_Index\(1))))
...
-- Equation(s):
-- \inst4|r_RX_Byte[6]~feeder_combout\ = \inst4|r_RX_Byte[6]~0_combout\
...
-- pragma translate_on
PORT MAP (
	datac => \inst4|r_RX_Byte[6]~0_combout\,
...
-- Equation(s):
-- \inst4|Decoder0~2_combout\ = (\inst4|r_Bit_Index\(2) & (\inst4|Decoder0~0_combout\ & (\inst4|r_Bit_Index\(0) & \inst4|r_Bit_Index\(1))))
...
-- Equation(s):
-- \inst9|dir~combout\ = (\inst4|r_RX_Byte\(6) & ((!\inst4|r_RX_Byte\(7)))) # (!\inst4|r_RX_Byte\(6) & (\inst9|dir~combout\))
...
\reseteo~input\ : fiftyfivenm_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	listen_to_nsleep_signal => "false",
...
\inst|dir~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst|dir~0_combout\ = (\inst9|dir~combout\) # (!\reseteo~input_o\)
...
-- pragma translate_on
PORT MAP (
	datac => \inst9|dir~combout\,
	datad => \reseteo~input_o\,
	combout => \inst|dir~0_combout\);

-- Location: LCCOMB_X16_Y8_N6
\inst|en~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst|en~0_combout\ = (!\reseteo~input_o\) # (!\inst4|r_RX_Byte\(6))
...
-- Equation(s):
-- \inst2|count~0_combout\ = (\inst2|Add1~28_combout\ & !\inst2|Equal0~4_combout\)
...
-- Equation(s):
-- \inst2|Equal0~0_combout\ = (\inst2|count\(14) & (\inst2|count\(11) & (!\inst2|count\(13) & !\inst2|count\(12))))
...
-- Equation(s):
-- \inst2|Equal0~2_combout\ = (\inst2|count\(5) & (!\inst2|count\(3) & (!\inst2|count\(4) & !\inst2|count\(6))))
...
-- Equation(s):
-- \inst2|Equal0~1_combout\ = (\inst2|count\(9) & (!\inst2|count\(7) & (\inst2|count\(10) & !\inst2|count\(8))))
...
-- Equation(s):
-- \inst2|Equal0~4_combout\ = (\inst2|Equal0~0_combout\ & (\inst2|Equal0~2_combout\ & (\inst2|Equal0~1_combout\ & \inst2|Equal0~3_combout\)))
...
-- Equation(s):
-- \inst2|count~3_combout\ = (\inst2|Add1~18_combout\ & !\inst2|Equal0~4_combout\)
...
-- Equation(s):
-- \inst2|count~2_combout\ = (\inst2|Add1~20_combout\ & !\inst2|Equal0~4_combout\)
...
-- Equation(s):
-- \inst2|count~1_combout\ = (\inst2|Add1~22_combout\ & !\inst2|Equal0~4_combout\)
...
-- Equation(s):
-- \inst4|Decoder0~4_combout\ = (\inst4|r_Bit_Index\(2) & (\inst4|Decoder0~0_combout\ & (!\inst4|r_Bit_Index\(0) & !\inst4|r_Bit_Index\(1))))
...
-- Equation(s):
-- \inst4|Decoder0~6_combout\ = (!\inst4|r_Bit_Index\(2) & (\inst4|Decoder0~0_combout\ & (!\inst4|r_Bit_Index\(0) & \inst4|r_Bit_Index\(1))))
...
-- Equation(s):
-- \inst4|Decoder0~5_combout\ = (!\inst4|r_Bit_Index\(2) & (\inst4|Decoder0~0_combout\ & (\inst4|r_Bit_Index\(0) & \inst4|r_Bit_Index\(1))))
...
-- Equation(s):
-- \inst4|Decoder0~7_combout\ = (\inst4|Decoder0~0_combout\ & (!\inst4|r_Bit_Index\(2) & (!\inst4|r_Bit_Index\(1) & \inst4|r_Bit_Index\(0))))
...
-- Equation(s):
-- \inst4|Decoder0~8_combout\ = (\inst4|Decoder0~0_combout\ & (!\inst4|r_Bit_Index\(2) & (!\inst4|r_Bit_Index\(0) & !\inst4|r_Bit_Index\(1))))
...
-- Equation(s):
-- \inst2|Mult0|mult_core|_~4_combout\ = (!\inst4|r_RX_Byte\(1) & !\inst4|r_RX_Byte\(0))
...
-- Equation(s):
-- \inst2|Mult0|mult_core|_~5_combout\ = (!\inst4|r_RX_Byte\(1) & \inst4|r_RX_Byte\(0))
...
-- Equation(s):
-- \inst2|Mult0|mult_core|_~6_combout\ = (\inst4|r_RX_Byte\(1) & !\inst4|r_RX_Byte\(0))
...
-- Equation(s):
-- \inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~0_combout\ = (\inst2|Mult0|mult_core|_~5_combout\ & (\inst4|r_RX_Byte\(2) $ (GND))) # (!\inst2|Mult0|mult_core|_~5_combout\ & (!\inst4|r_RX_Byte\(2) & VCC))
-- \inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~1\ = CARRY((\inst2|Mult0|mult_core|_~5_combout\ & !\inst4|r_RX_Byte\(2)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst2|Mult0|mult_core|_~5_combout\,
	datab => \inst4|r_RX_Byte\(2),
	datad => VCC,
...
-- Equation(s):
-- \inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~2_combout\ = (\inst2|Mult0|mult_core|_~6_combout\ & ((\inst2|Mult0|mult_core|romout[1][1]~3_combout\ & (\inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~1\ & VCC)) # 
-- (!\inst2|Mult0|mult_core|romout[1][1]~3_combout\ & (!\inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~1\)))) # (!\inst2|Mult0|mult_core|_~6_combout\ & ((\inst2|Mult0|mult_core|romout[1][1]~3_combout\ & 
-- (!\inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~1\)) # (!\inst2|Mult0|mult_core|romout[1][1]~3_combout\ & ((\inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~1\) # (GND)))))
-- \inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~3\ = CARRY((\inst2|Mult0|mult_core|_~6_combout\ & (!\inst2|Mult0|mult_core|romout[1][1]~3_combout\ & !\inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~1\)) # 
-- (!\inst2|Mult0|mult_core|_~6_combout\ & ((!\inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~1\) # (!\inst2|Mult0|mult_core|romout[1][1]~3_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst2|Mult0|mult_core|_~6_combout\,
	datab => \inst2|Mult0|mult_core|romout[1][1]~3_combout\,
	datad => VCC,
...
-- Equation(s):
-- \inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~4_combout\ = ((\inst2|Mult0|mult_core|_~5_combout\ $ (\inst2|Mult0|mult_core|romout[1][2]~2_combout\ $ (!\inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~3\)))) # (GND)
-- \inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~5\ = CARRY((\inst2|Mult0|mult_core|_~5_combout\ & ((\inst2|Mult0|mult_core|romout[1][2]~2_combout\) # (!\inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~3\))) # 
-- (!\inst2|Mult0|mult_core|_~5_combout\ & (\inst2|Mult0|mult_core|romout[1][2]~2_combout\ & !\inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~3\)))
...
PORT MAP (
	dataa => \inst2|Mult0|mult_core|_~5_combout\,
	datab => \inst2|Mult0|mult_core|romout[1][2]~2_combout\,
	datad => VCC,
...
-- pragma translate_on
PORT MAP (
	datab => \inst2|Mult0|mult_core|romout[1][5]~0_combout\,
	datad => VCC,
...
-- Equation(s):
-- \inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~12_combout\ = \inst2|Mult0|mult_core|padder|adder[0]|auto_generated|op_1~11\ $ (((!\inst2|Mult0|mult_core|_~0_combout\ & !\inst2|Mult0|mult_core|_~1_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst2|Mult0|mult_core|_~0_combout\,
	datad => \inst2|Mult0|mult_core|_~1_combout\,
...
-- Equation(s):
-- \inst2|Mult0|mult_core|romout[0][3]~4_combout\ = \inst4|r_RX_Byte\(1) $ (\inst4|r_RX_Byte\(0))
...
-- Equation(s):
-- \inst2|LessThan1~0_combout\ = (\inst2|count\(1) & \inst2|count\(0))
...
-- Equation(s):
-- \inst2|LessThan1~4_cout\ = CARRY((\inst4|r_RX_Byte\(0) & ((!\inst2|LessThan1~2_cout\) # (!\inst2|count\(2)))) # (!\inst4|r_RX_Byte\(0) & (!\inst2|count\(2) & !\inst2|LessThan1~2_cout\)))
...
-- Equation(s):
-- \inst2|LessThan1~6_cout\ = CARRY((\inst2|count\(3) & ((!\inst2|LessThan1~4_cout\) # (!\inst4|r_RX_Byte\(1)))) # (!\inst2|count\(3) & (!\inst4|r_RX_Byte\(1) & !\inst2|LessThan1~4_cout\)))
...
-- Equation(s):
-- \inst2|LessThan1~8_cout\ = CARRY((\inst2|Add0~4_combout\ & ((!\inst2|LessThan1~6_cout\) # (!\inst2|count\(4)))) # (!\inst2|Add0~4_combout\ & (!\inst2|count\(4) & !\inst2|LessThan1~6_cout\)))
...
-- Equation(s):
-- \inst2|LessThan1~10_cout\ = CARRY((\inst2|count\(5) & ((!\inst2|LessThan1~8_cout\) # (!\inst2|Add0~6_combout\))) # (!\inst2|count\(5) & (!\inst2|Add0~6_combout\ & !\inst2|LessThan1~8_cout\)))
...
-- Equation(s):
-- \inst2|LessThan1~12_cout\ = CARRY((\inst2|Add0~8_combout\ & ((!\inst2|LessThan1~10_cout\) # (!\inst2|count\(6)))) # (!\inst2|Add0~8_combout\ & (!\inst2|count\(6) & !\inst2|LessThan1~10_cout\)))
...
-- Equation(s):
-- \inst2|LessThan1~14_cout\ = CARRY((\inst2|Add0~10_combout\ & (\inst2|count\(7) & !\inst2|LessThan1~12_cout\)) # (!\inst2|Add0~10_combout\ & ((\inst2|count\(7)) # (!\inst2|LessThan1~12_cout\))))
...
-- Equation(s):
-- \inst2|LessThan1~16_cout\ = CARRY((\inst2|Add0~12_combout\ & ((!\inst2|LessThan1~14_cout\) # (!\inst2|count\(8)))) # (!\inst2|Add0~12_combout\ & (!\inst2|count\(8) & !\inst2|LessThan1~14_cout\)))
...
-- Equation(s):
-- \inst2|LessThan1~23_combout\ = (!\inst2|count\(12) & (!\inst2|LessThan1~21_combout\ & (!\inst2|count\(14) & !\inst2|count\(13))))
...
PORT MAP (
	...
	datab => \inst2|LessThan1~21_combout\,
...
-- Equation(s):
-- \inst4|Decoder0~3_combout\ = (\inst4|r_Bit_Index\(2) & (\inst4|Decoder0~0_combout\ & (\inst4|r_Bit_Index\(0) & !\inst4|r_Bit_Index\(1))))
